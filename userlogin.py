...
class main:
    ...
    def new_user(self):
        ...
        elif self.n_username.get()=='' or self.n_password.get()=='':
            mb.showerror('Error!','Username and Password field cannot be blanked.')
            self.log()
        else:
    ...
    def widgets(self):
        self.mainw = Label(self.master,text = 'LOGIN',font = ('',50),pady =25,fg="blue")
        self.mainw.pack()
...
root = Tk()
root.title("My Login Application")
main(root)
with sqlite3.connect('profile.db') as db:
    c = db.cursor()
